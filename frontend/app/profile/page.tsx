    ...
    <div className="flex h-screen bg-gray-50 dark:bg-dark-bg">
      ...
      <div className="flex-1 overflow-auto">
        ...
        <header className="bg-white dark:bg-dark-bg border-b border-gray-200 dark:border-gray-600 px-6 py-4">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">Manage your account and view usage statistics</p>
            </div>
        ...
        <div className="p-6 space-y-6">
          {/* Profile Information */}
          <div className="bg-white dark:bg-dark-bg rounded-lg shadow border border-gray-200 dark:border-gray-600 p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="ml-2 px-2 py-1 bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300 text-xs rounded-full">Verified</span>
                    </div>
                  </div>
          ...
          <div className="bg-white dark:bg-dark-bg rounded-lg shadow border border-gray-200 dark:border-gray-600 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <button className="flex items-center p-4 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                <Mail className="h-5 w-5 text-gray-600 dark:text-gray-300 mr-3" />
                <div className="text-left">
                  <p className="text-sm font-medium text-gray-900 dark:text-white">Change Email</p>
                  <p className="text-xs text-gray-600 dark:text-gray-400">Update your email address</p>
                </div>
              </button>
              ...
              <button className="flex items-center p-4 border border-red-300 dark:border-red-600 text-red-600 dark:text-red-400 rounded-lg hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors">
